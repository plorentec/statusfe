...
if (!geHtml.includes('name="is_global"')) { console.log('FAIL groups/edit: falta checkbox global'); failures++; }
if (!geHtml.includes('id="pageList"')) { console.log('FAIL groups/edit: falta lista de páginas'); failures++; }
